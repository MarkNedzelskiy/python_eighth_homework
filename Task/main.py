...
def remove_contact(reader):
    ...
    for row in reader:                                                                         #перезапись этого списка снова в файл, перезаписывая его. Наверное не 
...
def change_contact(reader):
    ...
    for row in reader:                                                                        #надо редактировать,если параметр будет у нескольких записей.  
        all_rows.append(row)                                                                  #Понимаю как надо это реализовывать, но если сейчас этим займусь, то просто взорвется голова)
